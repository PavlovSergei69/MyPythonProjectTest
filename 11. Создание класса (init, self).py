...
# # print(rich_uncle().balance, rich_uncle().country, sep=',')

#2_вариант
class rich_uncle:
    def __init__(self, balance, name, country):
        self.balance = balance                            #изменили работу функции в классе
        self.country = country
        self.name = name

uncle_jonh = rich_uncle(1000, 'Sergei','Russia')                            #теперь данные передаются отсюда
...
# uncle_jonh = rich_uncle('Sergei') # Присвоение данных
# uncle_jonh.get_private_plane()   # Вызов метода
